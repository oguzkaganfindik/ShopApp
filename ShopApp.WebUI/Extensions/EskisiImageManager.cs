...
{
    public static class EskisiImageManager
    {
        public static void ResizeImage(Stream sourceStream, string destinationImagePath, int width, int height)
        {
            using (var image = SixLabors.ImageSharp.Image.Load(sourceStream))
            {
